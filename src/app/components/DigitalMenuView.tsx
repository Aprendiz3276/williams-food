  ...
  return (
    ...
    >
      ...
      <div className="w-full h-screen flex flex-col items-center justify-center px-4 md:px-8 lg:px-12 relative">
        ...
        <div
          className={`w-full max-w-4xl h-[70vh] md:h-[75vh] lg:h-[80vh] flex items-center justify-center relative overflow-hidden rounded-2xl shadow-2xl transition-opacity duration-400 ${
